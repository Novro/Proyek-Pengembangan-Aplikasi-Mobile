...
-keep,includedescriptorclasses class com.example.fintrack.**$$serializer { *; }
-keepclassmembers class com.example.fintrack.** {
    *** Companion;
}
-keepclasseswithmembers class com.example.fintrack.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class com.example.fintrack.data.local.** { *; }
